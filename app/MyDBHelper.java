...
public class MyDBHelper extends SQLiteOpenHelper {
    ...
    private void dbCopy() {
        ...
        try {
            ...
            InputStream inputStream = mContext.getAssets().open("databases/membership.db");
            InputStream inputStream1 = mContext.getAssets().open("databases/soilder.db");
            ...
            while ((mLength = inputStream1.read(mBuffer)) > 0) {
                outputStream.write(mBuffer,0,mLength);
            }
            outputStream.flush();;
            outputStream.close();
